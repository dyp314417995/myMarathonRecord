...
// 表格数据里可能写入的字段（不含系统字段）
const TABLE_FIELDS = ["name","raceGroup","date","province","city","raceTypes","raceLevel","label","tags","scale","subScale","fee","organizer","operator","contactPhone","contactEmail","wechatAccount","website","mechanism","payment","signupChannels","medicalReport","finishRequirement","refundRule","startPoint","medalImage","routeMap","regStatus","timeline","status","source","sourceSite","sourceUrl","sourceId"];
